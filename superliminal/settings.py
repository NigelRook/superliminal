...
class Settings:
    def __init__(self, path):
        ...
        self._parser.set('general', 'min_movie_score', str(60))
        self._parser.set('general', 'min_episode_score', str(150))
        self._parser.set('general', 'desired_movie_score', str(119))
        self._parser.set('general', 'desired_episode_score', str(359))
